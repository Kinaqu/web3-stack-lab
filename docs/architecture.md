...
- [x] Local devnet starts via Docker Compose
- [x] RPC responds and can accept transactions
- [x] Deploy Counter → increment → verify via RPC
- [x] Explorer shows blocks/txs
- [x] Faucet rate-limits + logs distributions
- [x] Indexer writes to Postgres and survives restarts
